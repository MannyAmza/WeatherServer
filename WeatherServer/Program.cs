...
builder.Services.AddDbContext<CountriesSourceContext>(options =>
    ...
    //options.UseQueryTrackBehavior(QueryTrackingBehavior.NoTracking);
builder.Services.AddIdentity<WorldCitiesUser, IdentityRole>().AddEntityFrameworkStores<CountriesSourceContext>();
